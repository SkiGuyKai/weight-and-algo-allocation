...
class SectorAnalysis:
    ...
    def __ASSET_SECTOR_PERFORMANCE(self):
        ...
        translated_sectors = Translator(self.portfolio)
        portfolio_sectors = translated_sectors.new_sectors

        # selecting rows based on condition
        asp = self._RAW_SECTORS.loc[portfolio_sectors]
